...
import {ITheme, getTheme, getAvailableThemes} from "../config/theme"
...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({
    ...
    const [themeConfig, setThemeConfig] = useState<ITheme>(() => getTheme(currentTheme));
    ...
    const applyThemeToDOM = (theme: ITheme) => {
